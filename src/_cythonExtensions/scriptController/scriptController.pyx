...
cpdef void begin_script():
    ...
    from cythonExtensions.common import Management as mgmt, PThread
    from cythonExtensions.eventListeners import KeyPress, KeyRelease
    from time import sleep, time
    import scriptConfigs as configs
    from hookManager import HookManager, KeyboardHookManager
